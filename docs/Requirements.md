...
## FALTA ACEITAR O RATE PELA <URL>
## FALTA FORMATAR OS DADOS PARA PEGAR APENAS OS DOIS ULTIMOS NUMERO DEPOIS DA VIRGULA
## FALTA ELABORAR UM DOCKER-COMPOSE COM MYSQL MELHOR PARA CRIAR A TABELA E CONFIGURAR TUDO
## FALTA FAZER A INJECAO DE DEPENDENCIA -> TROCAR STRUCT POR INTERFACE
